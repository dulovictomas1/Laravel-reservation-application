<x-app-layout>
    ...
    @endif
        ...
        <div class="border p-4 mb-3" style="margin-bottom: 20px">            
            ...
            <form action="{{ route('admin.posts.createstore') }}" method="post">
                @csrf

                <div class="pole">
                    <div class="label-popis block font-medium text-sm text-gray-700">Názov stránky</div>
                    <input type="text" name="name" id="" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" placeholder="Zadajte názov stránky">    
                </div>
                ...
                <div class="pole">
                    <textarea name="text" id="" cols="30" rows="10" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" placeholder="Obsah stránky"></textarea>
                </div>
